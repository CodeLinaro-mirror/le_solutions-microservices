...
qtimlqnn name=stage_01_inference model=/etc/models/libqnn2.24_FD.so backend=/usr/lib/libQnnHtp.so \
qtimlvdetection name=stage_01_postproc stabilization=false threshold=51.0 results=6 module=qfd labels=/etc/labels/qfd.labels \
qtimlvconverter name=stage_02_preproc mode=roi-batch-cumulative \
qtimlqnn name=stage_02_inference model=/etc/models/libresnet_wd2_weak_score_1205_3ch.so backend=/usr/lib/libQnnHtp.so \
qtimlvpose name=stage_02_postproc threshold=51.0 results=6 module=lite-3dmm labels=/etc/labels/3dmm.labels \
qtimlvconverter name=stage_03_preproc mode=roi-batch-cumulative \
qtimlqnn name=stage_03_inference model=/etc/models/libqnn2.24_FR.so backend=/usr/lib/libQnnHtp.so \
qtimlvclassification name=stage_03_postproc threshold=60.0 results=6 module=qfr labels=/etc/labels/qfr.labels \
