...
std::string DeeplabArgmaxPostprocess::processSingle(
...
std::string DeeplabArgmaxPostprocess::process(const std::vector<OutputTensor>& raw, const RequestConfig& cfg) const {
