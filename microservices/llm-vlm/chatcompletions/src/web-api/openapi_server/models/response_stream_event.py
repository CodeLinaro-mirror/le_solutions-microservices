...
from openapi_server.models.response_audio_delta_event import ResponseAudioDeltaEvent
from openapi_server.models.response_audio_done_event import ResponseAudioDoneEvent
from openapi_server.models.response_audio_transcript_delta_event import ResponseAudioTranscriptDeltaEvent
from openapi_server.models.response_audio_transcript_done_event import ResponseAudioTranscriptDoneEvent
from openapi_server.models.response_code_interpreter_call_code_delta_event import ResponseCodeInterpreterCallCodeDeltaEvent
from openapi_server.models.response_code_interpreter_call_code_done_event import ResponseCodeInterpreterCallCodeDoneEvent
from openapi_server.models.response_code_interpreter_call_completed_event import ResponseCodeInterpreterCallCompletedEvent
from openapi_server.models.response_code_interpreter_call_in_progress_event import ResponseCodeInterpreterCallInProgressEvent
from openapi_server.models.response_code_interpreter_call_interpreting_event import ResponseCodeInterpreterCallInterpretingEvent
from openapi_server.models.response_completed_event import ResponseCompletedEvent
from openapi_server.models.response_content_part_added_event import ResponseContentPartAddedEvent
from openapi_server.models.response_content_part_done_event import ResponseContentPartDoneEvent
from openapi_server.models.response_created_event import ResponseCreatedEvent
from openapi_server.models.response_error_event import ResponseErrorEvent
from openapi_server.models.response_failed_event import ResponseFailedEvent
from openapi_server.models.response_file_search_call_completed_event import ResponseFileSearchCallCompletedEvent
from openapi_server.models.response_file_search_call_in_progress_event import ResponseFileSearchCallInProgressEvent
from openapi_server.models.response_file_search_call_searching_event import ResponseFileSearchCallSearchingEvent
from openapi_server.models.response_function_call_arguments_delta_event import ResponseFunctionCallArgumentsDeltaEvent
from openapi_server.models.response_function_call_arguments_done_event import ResponseFunctionCallArgumentsDoneEvent
from openapi_server.models.response_in_progress_event import ResponseInProgressEvent
from openapi_server.models.response_incomplete_event import ResponseIncompleteEvent
from openapi_server.models.response_output_item_added_event import ResponseOutputItemAddedEvent
from openapi_server.models.response_output_item_done_event import ResponseOutputItemDoneEvent
from openapi_server.models.response_reasoning_summary_part_added_event import ResponseReasoningSummaryPartAddedEvent
from openapi_server.models.response_reasoning_summary_part_done_event import ResponseReasoningSummaryPartDoneEvent
from openapi_server.models.response_reasoning_summary_text_delta_event import ResponseReasoningSummaryTextDeltaEvent
from openapi_server.models.response_reasoning_summary_text_done_event import ResponseReasoningSummaryTextDoneEvent
from openapi_server.models.response_refusal_delta_event import ResponseRefusalDeltaEvent
from openapi_server.models.response_refusal_done_event import ResponseRefusalDoneEvent
from openapi_server.models.response_text_annotation_delta_event import ResponseTextAnnotationDeltaEvent
from openapi_server.models.response_text_delta_event import ResponseTextDeltaEvent
from openapi_server.models.response_text_done_event import ResponseTextDoneEvent
from openapi_server.models.response_web_search_call_completed_event import ResponseWebSearchCallCompletedEvent
from openapi_server.models.response_web_search_call_in_progress_event import ResponseWebSearchCallInProgressEvent
from openapi_server.models.response_web_search_call_searching_event import ResponseWebSearchCallSearchingEvent
...
RESPONSESTREAMEVENT_ANY_OF_SCHEMAS = ["ResponseAudioDeltaEvent", "ResponseAudioDoneEvent", "ResponseAudioTranscriptDeltaEvent", "ResponseAudioTranscriptDoneEvent", "ResponseCodeInterpreterCallCodeDeltaEvent", "ResponseCodeInterpreterCallCodeDoneEvent", "ResponseCodeInterpreterCallCompletedEvent", "ResponseCodeInterpreterCallInProgressEvent", "ResponseCodeInterpreterCallInterpretingEvent", "ResponseCompletedEvent", "ResponseContentPartAddedEvent", "ResponseContentPartDoneEvent", "ResponseCreatedEvent", "ResponseErrorEvent", "ResponseFailedEvent", "ResponseFileSearchCallCompletedEvent", "ResponseFileSearchCallInProgressEvent", "ResponseFileSearchCallSearchingEvent", "ResponseFunctionCallArgumentsDeltaEvent", "ResponseFunctionCallArgumentsDoneEvent", "ResponseInProgressEvent", "ResponseIncompleteEvent", "ResponseOutputItemAddedEvent", "ResponseOutputItemDoneEvent", "ResponseReasoningSummaryPartAddedEvent", "ResponseReasoningSummaryPartDoneEvent", "ResponseReasoningSummaryTextDeltaEvent", "ResponseReasoningSummaryTextDoneEvent", "ResponseRefusalDeltaEvent", "ResponseRefusalDoneEvent", "ResponseTextAnnotationDeltaEvent", "ResponseTextDeltaEvent", "ResponseTextDoneEvent", "ResponseWebSearchCallCompletedEvent", "ResponseWebSearchCallInProgressEvent", "ResponseWebSearchCallSearchingEvent"]
...
class ResponseStreamEvent(BaseModel):
    ...
    # data type: ResponseReasoningSummaryPartAddedEvent
    anyof_schema_25_validator: Optional[ResponseReasoningSummaryPartAddedEvent] = None
    # data type: ResponseReasoningSummaryPartDoneEvent
    anyof_schema_26_validator: Optional[ResponseReasoningSummaryPartDoneEvent] = None
    # data type: ResponseReasoningSummaryTextDeltaEvent
    anyof_schema_27_validator: Optional[ResponseReasoningSummaryTextDeltaEvent] = None
    # data type: ResponseReasoningSummaryTextDoneEvent
    anyof_schema_28_validator: Optional[ResponseReasoningSummaryTextDoneEvent] = None
    # data type: ResponseRefusalDeltaEvent
    anyof_schema_29_validator: Optional[ResponseRefusalDeltaEvent] = None
    # data type: ResponseRefusalDoneEvent
    anyof_schema_30_validator: Optional[ResponseRefusalDoneEvent] = None
    # data type: ResponseTextAnnotationDeltaEvent
    anyof_schema_31_validator: Optional[ResponseTextAnnotationDeltaEvent] = None
    # data type: ResponseTextDeltaEvent
    anyof_schema_32_validator: Optional[ResponseTextDeltaEvent] = None
    # data type: ResponseTextDoneEvent
    anyof_schema_33_validator: Optional[ResponseTextDoneEvent] = None
    # data type: ResponseWebSearchCallCompletedEvent
    anyof_schema_34_validator: Optional[ResponseWebSearchCallCompletedEvent] = None
    # data type: ResponseWebSearchCallInProgressEvent
    anyof_schema_35_validator: Optional[ResponseWebSearchCallInProgressEvent] = None
    # data type: ResponseWebSearchCallSearchingEvent
    anyof_schema_36_validator: Optional[ResponseWebSearchCallSearchingEvent] = None
    if TYPE_CHECKING:
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        # validate data type: ResponseReasoningSummaryPartAddedEvent
        if not isinstance(v, ResponseReasoningSummaryPartAddedEvent):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ResponseReasoningSummaryPartAddedEvent`")
        else:
            return v

        # validate data type: ResponseReasoningSummaryPartDoneEvent
        if not isinstance(v, ResponseReasoningSummaryPartDoneEvent):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ResponseReasoningSummaryPartDoneEvent`")
        else:
            return v

        # validate data type: ResponseReasoningSummaryTextDeltaEvent
        if not isinstance(v, ResponseReasoningSummaryTextDeltaEvent):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ResponseReasoningSummaryTextDeltaEvent`")
        else:
            return v

        # validate data type: ResponseReasoningSummaryTextDoneEvent
        if not isinstance(v, ResponseReasoningSummaryTextDoneEvent):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ResponseReasoningSummaryTextDoneEvent`")
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_25_validator: Optional[ResponseReasoningSummaryPartAddedEvent] = None
        try:
            instance.actual_instance = ResponseReasoningSummaryPartAddedEvent.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_26_validator: Optional[ResponseReasoningSummaryPartDoneEvent] = None
        try:
            instance.actual_instance = ResponseReasoningSummaryPartDoneEvent.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_27_validator: Optional[ResponseReasoningSummaryTextDeltaEvent] = None
        try:
            instance.actual_instance = ResponseReasoningSummaryTextDeltaEvent.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_28_validator: Optional[ResponseReasoningSummaryTextDoneEvent] = None
        try:
            instance.actual_instance = ResponseReasoningSummaryTextDoneEvent.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_29_validator: Optional[ResponseRefusalDeltaEvent] = None
