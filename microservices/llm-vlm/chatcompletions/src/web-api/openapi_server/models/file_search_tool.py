...
from openapi_server.models.ranking_options import RankingOptions
try:
...
class FileSearchTool(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "vector_store_ids", "max_num_results", "ranking_options", "filters"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'file_search',
            "vector_store_ids": obj.get("vector_store_ids"),
            "max_num_results": obj.get("max_num_results"),
            "ranking_options": RankingOptions.from_dict(obj.get("ranking_options")) if obj.get("ranking_options") is not None else None,
