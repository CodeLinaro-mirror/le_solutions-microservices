...
from openapi_server.models.audit_log_certificate_created import AuditLogCertificateCreated
from openapi_server.models.audit_log_certificate_deleted import AuditLogCertificateDeleted
from openapi_server.models.audit_log_certificates_activated import AuditLogCertificatesActivated
from openapi_server.models.audit_log_checkpoint_permission_created import AuditLogCheckpointPermissionCreated
from openapi_server.models.audit_log_checkpoint_permission_deleted import AuditLogCheckpointPermissionDeleted
...
class AuditLog(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "checkpoint_permission.created": AuditLogCheckpointPermissionCreated.from_dict(obj.get("checkpoint_permission.created")) if obj.get("checkpoint_permission.created") is not None else None,
            "checkpoint_permission.deleted": AuditLogCheckpointPermissionDeleted.from_dict(obj.get("checkpoint_permission.deleted")) if obj.get("checkpoint_permission.deleted") is not None else None,
            ...
            "certificate.created": AuditLogCertificateCreated.from_dict(obj.get("certificate.created")) if obj.get("certificate.created") is not None else None,
            "certificate.updated": AuditLogCertificateCreated.from_dict(obj.get("certificate.updated")) if obj.get("certificate.updated") is not None else None,
            "certificate.deleted": AuditLogCertificateDeleted.from_dict(obj.get("certificate.deleted")) if obj.get("certificate.deleted") is not None else None,
            "certificates.activated": AuditLogCertificatesActivated.from_dict(obj.get("certificates.activated")) if obj.get("certificates.activated") is not None else None,
            "certificates.deactivated": AuditLogCertificatesActivated.from_dict(obj.get("certificates.deactivated")) if obj.get("certificates.deactivated") is not None else None
        })
        return _obj
