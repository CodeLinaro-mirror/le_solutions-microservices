...
class ComputerAction(BaseModel):
    ...
    one_of_schemas: Set[str] = { "Click", "DoubleClick", "Drag", "KeyPress", "Move", "Screenshot", "Scroll", "Type", "Wait" }
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], Click, DoubleClick, Drag, KeyPress, Move, Screenshot, Scroll, Type, Wait]]:
