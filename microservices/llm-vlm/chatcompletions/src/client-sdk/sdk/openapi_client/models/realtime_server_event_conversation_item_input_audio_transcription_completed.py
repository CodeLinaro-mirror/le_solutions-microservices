...
class RealtimeServerEventConversationItemInputAudioTranscriptionCompleted(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['conversation.item.input_audio_transcription.completed']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "logprobs": [LogProbProperties.from_dict(_item) for _item in obj["logprobs"]] if obj.get("logprobs") is not None else None
        })
        return _obj
