...
class RealtimeServerEvent(BaseModel):
    ...
    # data type: RealtimeServerEventOutputAudioBufferStarted
    anyof_schema_32_validator: Optional[RealtimeServerEventOutputAudioBufferStarted] = None
    # data type: RealtimeServerEventOutputAudioBufferStopped
    anyof_schema_33_validator: Optional[RealtimeServerEventOutputAudioBufferStopped] = None
    # data type: RealtimeServerEventOutputAudioBufferCleared
    anyof_schema_34_validator: Optional[RealtimeServerEventOutputAudioBufferCleared] = None
    if TYPE_CHECKING:
    ...
    any_of_schemas: Set[str] = { "RealtimeServerEventConversationCreated", "RealtimeServerEventConversationItemCreated", "RealtimeServerEventConversationItemDeleted", "RealtimeServerEventConversationItemInputAudioTranscriptionCompleted", "RealtimeServerEventConversationItemInputAudioTranscriptionDelta", "RealtimeServerEventConversationItemInputAudioTranscriptionFailed", "RealtimeServerEventConversationItemRetrieved", "RealtimeServerEventConversationItemTruncated", "RealtimeServerEventError", "RealtimeServerEventInputAudioBufferCleared", "RealtimeServerEventInputAudioBufferCommitted", "RealtimeServerEventInputAudioBufferSpeechStarted", "RealtimeServerEventInputAudioBufferSpeechStopped", "RealtimeServerEventOutputAudioBufferCleared", "RealtimeServerEventOutputAudioBufferStarted", "RealtimeServerEventOutputAudioBufferStopped", "RealtimeServerEventRateLimitsUpdated", "RealtimeServerEventResponseAudioDelta", "RealtimeServerEventResponseAudioDone", "RealtimeServerEventResponseAudioTranscriptDelta", "RealtimeServerEventResponseAudioTranscriptDone", "RealtimeServerEventResponseContentPartAdded", "RealtimeServerEventResponseContentPartDone", "RealtimeServerEventResponseCreated", "RealtimeServerEventResponseDone", "RealtimeServerEventResponseFunctionCallArgumentsDelta", "RealtimeServerEventResponseFunctionCallArgumentsDone", "RealtimeServerEventResponseOutputItemAdded", "RealtimeServerEventResponseOutputItemDone", "RealtimeServerEventResponseTextDelta", "RealtimeServerEventResponseTextDone", "RealtimeServerEventSessionCreated", "RealtimeServerEventSessionUpdated", "RealtimeServerEventTranscriptionSessionUpdated" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        # validate data type: RealtimeServerEventOutputAudioBufferStarted
        if not isinstance(v, RealtimeServerEventOutputAudioBufferStarted):
            error_messages.append(f"Error! Input type `{type(v)}` is not `RealtimeServerEventOutputAudioBufferStarted`")
        else:
            return v

        # validate data type: RealtimeServerEventOutputAudioBufferStopped
        if not isinstance(v, RealtimeServerEventOutputAudioBufferStopped):
            error_messages.append(f"Error! Input type `{type(v)}` is not `RealtimeServerEventOutputAudioBufferStopped`")
        else:
            return v

        # validate data type: RealtimeServerEventOutputAudioBufferCleared
        if not isinstance(v, RealtimeServerEventOutputAudioBufferCleared):
            error_messages.append(f"Error! Input type `{type(v)}` is not `RealtimeServerEventOutputAudioBufferCleared`")
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_32_validator: Optional[RealtimeServerEventOutputAudioBufferStarted] = None
        try:
            instance.actual_instance = RealtimeServerEventOutputAudioBufferStarted.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_33_validator: Optional[RealtimeServerEventOutputAudioBufferStopped] = None
        try:
            instance.actual_instance = RealtimeServerEventOutputAudioBufferStopped.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_34_validator: Optional[RealtimeServerEventOutputAudioBufferCleared] = None
        try:
            instance.actual_instance = RealtimeServerEventOutputAudioBufferCleared.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], RealtimeServerEventConversationCreated, RealtimeServerEventConversationItemCreated, RealtimeServerEventConversationItemDeleted, RealtimeServerEventConversationItemInputAudioTranscriptionCompleted, RealtimeServerEventConversationItemInputAudioTranscriptionDelta, RealtimeServerEventConversationItemInputAudioTranscriptionFailed, RealtimeServerEventConversationItemRetrieved, RealtimeServerEventConversationItemTruncated, RealtimeServerEventError, RealtimeServerEventInputAudioBufferCleared, RealtimeServerEventInputAudioBufferCommitted, RealtimeServerEventInputAudioBufferSpeechStarted, RealtimeServerEventInputAudioBufferSpeechStopped, RealtimeServerEventOutputAudioBufferCleared, RealtimeServerEventOutputAudioBufferStarted, RealtimeServerEventOutputAudioBufferStopped, RealtimeServerEventRateLimitsUpdated, RealtimeServerEventResponseAudioDelta, RealtimeServerEventResponseAudioDone, RealtimeServerEventResponseAudioTranscriptDelta, RealtimeServerEventResponseAudioTranscriptDone, RealtimeServerEventResponseContentPartAdded, RealtimeServerEventResponseContentPartDone, RealtimeServerEventResponseCreated, RealtimeServerEventResponseDone, RealtimeServerEventResponseFunctionCallArgumentsDelta, RealtimeServerEventResponseFunctionCallArgumentsDone, RealtimeServerEventResponseOutputItemAdded, RealtimeServerEventResponseOutputItemDone, RealtimeServerEventResponseTextDelta, RealtimeServerEventResponseTextDone, RealtimeServerEventSessionCreated, RealtimeServerEventSessionUpdated, RealtimeServerEventTranscriptionSessionUpdated]]:
