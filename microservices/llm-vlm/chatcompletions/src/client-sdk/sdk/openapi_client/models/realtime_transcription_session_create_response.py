...
class RealtimeTranscriptionSessionCreateResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "client_secret": RealtimeTranscriptionSessionCreateResponseClientSecret.from_dict(obj["client_secret"]) if obj.get("client_secret") is not None else None,
            "modalities": obj.get("modalities"),
            "input_audio_format": obj.get("input_audio_format"),
            "input_audio_transcription": RealtimeTranscriptionSessionCreateResponseInputAudioTranscription.from_dict(obj["input_audio_transcription"]) if obj.get("input_audio_transcription") is not None else None,
