...
class RealtimeClientEventTranscriptionSessionUpdate(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['transcription_session.update']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "session": RealtimeTranscriptionSessionCreateRequest.from_dict(obj["session"]) if obj.get("session") is not None else None
        })
        return _obj
