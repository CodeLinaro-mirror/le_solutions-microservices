...
class MessageContentTextObjectTextAnnotationsInner(BaseModel):
    ...
    one_of_schemas: Set[str] = { "MessageContentTextAnnotationsFileCitationObject", "MessageContentTextAnnotationsFilePathObject" }
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], MessageContentTextAnnotationsFileCitationObject, MessageContentTextAnnotationsFilePathObject]]:
