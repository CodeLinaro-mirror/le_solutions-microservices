...
class CreateChatCompletionRequest(BaseModel):
    ...
    model: Optional[ModelIdsShared] = None
    ...
    stream: Optional[StrictBool] = Field(default=False, description="If set to true, the model response data will be streamed to the client as it is generated using [server-sent events]. See the [Streaming section below](/docs/api-reference/chat/streaming) for more information, along with the [streaming responses](/docs/guides/streaming-responses) guide for more information on how to handle the streaming events. ")
    ...
    max_tokens: Optional[StrictInt] = Field(default=None, description="The maximum number of [tokens](/tokenizer) that can be generated in the chat completion. This value can be used to control costs for text generated via API.  This value is now deprecated in favor of `max_completion_tokens`, and is not compatible with [o-series models](/docs/guides/reasoning). ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "model": ModelIdsShared.from_dict(obj["model"]) if obj.get("model") is not None else None,
            ...
            "web_search_options": WebSearch.from_dict(obj["web_search_options"]) if obj.get("web_search_options") is not None else None,
            "top_logprobs": obj.get("top_logprobs"),
            "response_format": CreateChatCompletionRequestAllOfResponseFormat.from_dict(obj["response_format"]) if obj.get("response_format") is not None else None,
            "audio": CreateChatCompletionRequestAllOfAudio.from_dict(obj["audio"]) if obj.get("audio") is not None else None,
            ...
            "stop": StopConfiguration.from_dict(obj["stop"]) if obj.get("stop") is not None else None,
            ...
            "prediction": CreateChatCompletionRequestAllOfPrediction.from_dict(obj["prediction"]) if obj.get("prediction") is not None else None,
            "seed": obj.get("seed"),
            ...
            "function_call": CreateChatCompletionRequestAllOfFunctionCall.from_dict(obj["function_call"]) if obj.get("function_call") is not None else None,
