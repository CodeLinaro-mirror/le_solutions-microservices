...
class CreateThreadRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "messages": [CreateMessageRequest.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None,
            "tool_resources": CreateThreadRequestToolResources.from_dict(obj["tool_resources"]) if obj.get("tool_resources") is not None else None,
