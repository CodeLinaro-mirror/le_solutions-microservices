...
class RunStepDeltaObjectDeltaStepDetails(BaseModel):
    ...
    one_of_schemas: Set[str] = { "RunStepDeltaStepDetailsMessageCreationObject", "RunStepDeltaStepDetailsToolCallsObject" }
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], RunStepDeltaStepDetailsMessageCreationObject, RunStepDeltaStepDetailsToolCallsObject]]:
