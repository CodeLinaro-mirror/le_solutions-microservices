...
class ItemResource(BaseModel):
    ...
    one_of_schemas: Set[str] = { "ComputerToolCall", "ComputerToolCallOutputResource", "FileSearchToolCall", "FunctionToolCallOutputResource", "FunctionToolCallResource", "InputMessageResource", "OutputMessage", "WebSearchToolCall" }
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], ComputerToolCall, ComputerToolCallOutputResource, FileSearchToolCall, FunctionToolCallOutputResource, FunctionToolCallResource, InputMessageResource, OutputMessage, WebSearchToolCall]]:
