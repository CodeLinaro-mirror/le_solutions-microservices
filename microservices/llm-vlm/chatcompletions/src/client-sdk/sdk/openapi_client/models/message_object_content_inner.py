...
class MessageObjectContentInner(BaseModel):
    ...
    one_of_schemas: Set[str] = { "MessageContentImageFileObject", "MessageContentImageUrlObject", "MessageContentRefusalObject", "MessageContentTextObject" }
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], MessageContentImageFileObject, MessageContentImageUrlObject, MessageContentRefusalObject, MessageContentTextObject]]:
