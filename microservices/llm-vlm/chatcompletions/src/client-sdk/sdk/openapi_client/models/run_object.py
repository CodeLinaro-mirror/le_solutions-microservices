...
class RunObject(BaseModel):
    ...
    def object_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['thread.run']):
    ...
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['queued', 'in_progress', 'requires_action', 'cancelling', 'cancelled', 'failed', 'completed', 'incomplete', 'expired']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "required_action": RunObjectRequiredAction.from_dict(obj["required_action"]) if obj.get("required_action") is not None else None,
            "last_error": RunObjectLastError.from_dict(obj["last_error"]) if obj.get("last_error") is not None else None,
            "expires_at": obj.get("expires_at"),
            "started_at": obj.get("started_at"),
            "cancelled_at": obj.get("cancelled_at"),
            "failed_at": obj.get("failed_at"),
            "completed_at": obj.get("completed_at"),
            "incomplete_details": RunObjectIncompleteDetails.from_dict(obj["incomplete_details"]) if obj.get("incomplete_details") is not None else None,
            "model": obj.get("model"),
            "instructions": obj.get("instructions"),
            "tools": [AssistantObjectToolsInner.from_dict(_item) for _item in obj["tools"]] if obj.get("tools") is not None else None,
            "metadata": obj.get("metadata"),
            "usage": RunCompletionUsage.from_dict(obj["usage"]) if obj.get("usage") is not None else None,
            "temperature": obj.get("temperature"),
            "top_p": obj.get("top_p"),
            "max_prompt_tokens": obj.get("max_prompt_tokens"),
            "max_completion_tokens": obj.get("max_completion_tokens"),
            "truncation_strategy": CreateRunRequestTruncationStrategy.from_dict(obj["truncation_strategy"]) if obj.get("truncation_strategy") is not None else None,
            "tool_choice": CreateRunRequestToolChoice.from_dict(obj["tool_choice"]) if obj.get("tool_choice") is not None else None,
