...
class Response(BaseModel):
    ...
    instructions: Optional[StrictStr] = Field(description="Inserts a system (or developer) message as the first item in the model's context.  When using along with `previous_response_id`, the instructions from a previous response will not be carried over to the next response. This makes it simple to swap out system (or developer) messages in new responses. ")
    ...
    __properties: ClassVar[List[str]] = ["metadata", "temperature", "top_p", "user", "service_tier", "previous_response_id", "model", "reasoning", "max_output_tokens", "instructions", "text", "tools", "tool_choice", "truncation", "id", "object", "status", "created_at", "error", "incomplete_details", "output", "output_text", "usage", "parallel_tool_calls"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['completed', 'failed', 'in_progress', 'incomplete']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "incomplete_details": ResponseAllOfIncompleteDetails.from_dict(obj["incomplete_details"]) if obj.get("incomplete_details") is not None else None,
            "output": [OutputItem.from_dict(_item) for _item in obj["output"]] if obj.get("output") is not None else None,
