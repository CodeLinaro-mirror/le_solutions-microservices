...
class RealtimeServerEventConversationItemInputAudioTranscriptionFailed(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['conversation.item.input_audio_transcription.failed']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "error": RealtimeServerEventConversationItemInputAudioTranscriptionFailedError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
