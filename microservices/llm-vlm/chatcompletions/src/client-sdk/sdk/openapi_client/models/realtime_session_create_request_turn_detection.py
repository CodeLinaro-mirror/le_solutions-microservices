...
class RealtimeSessionCreateRequestTurnDetection(BaseModel):
    """
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Type of turn detection. ")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['server_vad', 'semantic_vad']):
    ...
    def eagerness_validate_enum(cls, value):
        ...
        if value not in set(['low', 'medium', 'high', 'auto']):
