...
class RealtimeSessionCreateResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "input_audio_transcription": RealtimeSessionCreateResponseInputAudioTranscription.from_dict(obj["input_audio_transcription"]) if obj.get("input_audio_transcription") is not None else None,
