...
class ModifyAssistantRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "model": ModifyAssistantRequestModel.from_dict(obj["model"]) if obj.get("model") is not None else None,
            ...
            "tool_resources": ModifyAssistantRequestToolResources.from_dict(obj["tool_resources"]) if obj.get("tool_resources") is not None else None,
