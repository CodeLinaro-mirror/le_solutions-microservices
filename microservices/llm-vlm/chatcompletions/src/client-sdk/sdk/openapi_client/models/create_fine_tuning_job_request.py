...
class CreateFineTuningJobRequest(BaseModel):
    ...
    suffix: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=64)]] = Field(default=None, description="A string of up to 64 characters that will be added to your fine-tuned model name.  For example, a `suffix` of \"custom-model-name\" would produce a model ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "seed": obj.get("seed"),
            "method": FineTuneMethod.from_dict(obj["method"]) if obj.get("method") is not None else None,
