...
------------ | ------------- | ------------- | -------------
**type** | **str** | Type of turn detection.  | [optional] 
...
json = "{}"
# create an instance of RealtimeSessionCreateRequestTurnDetection from a JSON string
realtime_session_create_request_turn_detection_instance = RealtimeSessionCreateRequestTurnDetection.from_json(json)
# print the JSON string representation of the object
print(RealtimeSessionCreateRequestTurnDetection.to_json())

# convert the object into a dict
realtime_session_create_request_turn_detection_dict = realtime_session_create_request_turn_detection_instance.to_dict()
# create an instance of RealtimeSessionCreateRequestTurnDetection from a dict
realtime_session_create_request_turn_detection_from_dict = RealtimeSessionCreateRequestTurnDetection.from_dict(realtime_session_create_request_turn_detection_dict)
```
