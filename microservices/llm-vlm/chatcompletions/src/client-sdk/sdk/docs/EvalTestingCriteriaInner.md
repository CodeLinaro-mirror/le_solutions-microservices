...
json = "{}"
# create an instance of EvalTestingCriteriaInner from a JSON string
eval_testing_criteria_inner_instance = EvalTestingCriteriaInner.from_json(json)
# print the JSON string representation of the object
print(EvalTestingCriteriaInner.to_json())

# convert the object into a dict
eval_testing_criteria_inner_dict = eval_testing_criteria_inner_instance.to_dict()
# create an instance of EvalTestingCriteriaInner from a dict
eval_testing_criteria_inner_from_dict = EvalTestingCriteriaInner.from_dict(eval_testing_criteria_inner_dict)
```
