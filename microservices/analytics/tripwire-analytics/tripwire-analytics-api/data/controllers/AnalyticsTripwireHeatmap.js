...
module.exports.getAnalyticsHeatmap = async function getAnalyticsHeatmap (req, res, next, body) {
    // send Analytics request and get back data
    try {
        /*
        /   Send data to the TA Server through analytics redis channel
        /   Get Data back from the TA Server
        ...
        */
        ...
        redis.publishAndListenOnce(data, async (err, retData) => {
            if (err) {
                ...
                // TODO: Make sure that the Array data being sent back actually fits
