 ...
 * Description :- The file stores the constants related to Redis based interaction.
 */
'use strict';
...
export const RedisConstants = Object.freeze({
  ...
  CONNECTION_RETRY_INTERVAL: 10000, // 10 seconds delay between connection retry
  CONNECTION_TIMEOUT: 30000, // 30 seconds timeout declared in milliseconds
})