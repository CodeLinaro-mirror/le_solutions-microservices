 ...
 * Description :- The file stores the constants related to Kafka based interaction.
 */
'use strict';
...
export const KafkaConstants = Object.freeze({
  ...
  CONNECTION_HEALTH_CHECK_INTERVAL: 60000, // Interval in milliseconds for sending connection health check's ping message.
  CONNECTION_INITIAL_RETRY_TIME: 500,
  CONNECTION_BACKOFF_MULTIPLIER: 2,
  CONNECTION_RANDOMIZATION_FACTOR: 0.5,
  CONNECTION_MAXIMUM_RETRY_DELAY: 10000, // Maximum 10 seconds delay between connection retrial
