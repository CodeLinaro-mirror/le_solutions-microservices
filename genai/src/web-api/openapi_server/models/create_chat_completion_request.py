...
from openapi_server.models.create_chat_completion_request_all_of_prediction import CreateChatCompletionRequestAllOfPrediction
...
ChatCompletionRequestMessage = Union[ChatCompletionRequestSystemMessage, ChatCompletionRequestUserMessage, ChatCompletionRequestAssistantMessage, ChatCompletionRequestToolMessage]
...
class CreateChatCompletionRequest(BaseModel):
    ...
    top_k: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=40, description="Top-k sampling parameter. If specified, the sampler considers only the k most likely next tokens at each step. If omitted, the model's configured sampler defaults are used. ")
