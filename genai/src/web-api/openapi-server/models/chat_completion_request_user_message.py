...
ChatCompletionRequestUserMessageContent = Union[StrictStr, List[ChatCompletionRequestUserMessageContentPart]]
...
class ChatCompletionRequestUserMessage(BaseModel):
    ...
    role: StrictStr =  Literal["user"] #Field(description="The role of the messages author, in this case `user`.")
