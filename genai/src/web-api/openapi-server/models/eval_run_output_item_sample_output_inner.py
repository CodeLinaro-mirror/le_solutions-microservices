...
class EvalRunOutputItemSampleOutputInner(BaseModel):
    """
    EvalRunOutputItemSampleOutputInner
    """ # noqa: E501
    role: Optional[StrictStr] = Field(default=None, description="The role of the message (e.g. \"system\", \"assistant\", \"user\").")
