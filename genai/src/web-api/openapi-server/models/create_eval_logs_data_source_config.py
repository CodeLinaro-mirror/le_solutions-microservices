...
class CreateEvalLogsDataSourceConfig(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="The type of data source. Always `logs`.")
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="Metadata filters for the logs data source.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'logs',
