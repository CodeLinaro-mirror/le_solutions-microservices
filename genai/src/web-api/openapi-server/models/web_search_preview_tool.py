...
from openapi_server.models.approximate_location import ApproximateLocation
try:
...
class WebSearchPreviewTool(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "user_location": ApproximateLocation.from_dict(obj.get("user_location")) if obj.get("user_location") is not None else None,
