...
class ChatApi:
    ...
    def add_chat_completion(
    ...
    ) -> Union[CreateChatCompletionResponse, RESTResponseType]:
        """Adds a chat to existing conversation.

        :param completion_id: id of conversation (required)
        ...
        _param = self._add_chat_completion_serialize(
    ...
    @validate_call
    def add_chat_completion_with_http_info(
        self,
        completion_id: Annotated[StrictStr, Field(description="id of conversation")],
        create_chat_completion_request: CreateChatCompletionRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def add_chat_completion_without_preload_content(
        self,
        completion_id: Annotated[StrictStr, Field(description="id of conversation")],
        create_chat_completion_request: CreateChatCompletionRequest,
        _request_timeout: Union[
    ...
    def _add_chat_completion_serialize(
        self,
        completion_id,
    ...
    def delete_chat_completion(
        ...
        :param completion_id: The ID of the chat completion to delete. (required)
        :type completion_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._delete_chat_completion_serialize(
            completion_id=completion_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_chat_completion_with_http_info(
        self,
        completion_id: Annotated[StrictStr, Field(description="The ID of the chat completion to delete.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_chat_completion_without_preload_content(
        self,
        completion_id: Annotated[StrictStr, Field(description="The ID of the chat completion to delete.")],
        _request_timeout: Union[
            None,
    ...
    def _delete_chat_completion_serialize(
        self,
        completion_id,
        _request_auth,
        _content_type,
