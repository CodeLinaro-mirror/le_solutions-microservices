...
class RealtimeClientEvent(BaseModel):
    ...
    # data type: RealtimeClientEventOutputAudioBufferClear
    anyof_schema_7_validator: Optional[RealtimeClientEventOutputAudioBufferClear] = None
    # data type: RealtimeClientEventInputAudioBufferCommit
    anyof_schema_8_validator: Optional[RealtimeClientEventInputAudioBufferCommit] = None
    # data type: RealtimeClientEventResponseCancel
    anyof_schema_9_validator: Optional[RealtimeClientEventResponseCancel] = None
    # data type: RealtimeClientEventResponseCreate
    anyof_schema_10_validator: Optional[RealtimeClientEventResponseCreate] = None
    # data type: RealtimeClientEventSessionUpdate
    anyof_schema_11_validator: Optional[RealtimeClientEventSessionUpdate] = None
    # data type: RealtimeClientEventTranscriptionSessionUpdate
    anyof_schema_12_validator: Optional[RealtimeClientEventTranscriptionSessionUpdate] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[RealtimeClientEventConversationItemCreate, RealtimeClientEventConversationItemDelete, RealtimeClientEventConversationItemRetrieve, RealtimeClientEventConversationItemTruncate, RealtimeClientEventInputAudioBufferAppend, RealtimeClientEventInputAudioBufferClear, RealtimeClientEventInputAudioBufferCommit, RealtimeClientEventOutputAudioBufferClear, RealtimeClientEventResponseCancel, RealtimeClientEventResponseCreate, RealtimeClientEventSessionUpdate, RealtimeClientEventTranscriptionSessionUpdate]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "RealtimeClientEventConversationItemCreate", "RealtimeClientEventConversationItemDelete", "RealtimeClientEventConversationItemRetrieve", "RealtimeClientEventConversationItemTruncate", "RealtimeClientEventInputAudioBufferAppend", "RealtimeClientEventInputAudioBufferClear", "RealtimeClientEventInputAudioBufferCommit", "RealtimeClientEventOutputAudioBufferClear", "RealtimeClientEventResponseCancel", "RealtimeClientEventResponseCreate", "RealtimeClientEventSessionUpdate", "RealtimeClientEventTranscriptionSessionUpdate" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        # validate data type: RealtimeClientEventOutputAudioBufferClear
        if not isinstance(v, RealtimeClientEventOutputAudioBufferClear):
            error_messages.append(f"Error! Input type `{type(v)}` is not `RealtimeClientEventOutputAudioBufferClear`")
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_7_validator: Optional[RealtimeClientEventOutputAudioBufferClear] = None
        try:
            instance.actual_instance = RealtimeClientEventOutputAudioBufferClear.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_8_validator: Optional[RealtimeClientEventInputAudioBufferCommit] = None
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], RealtimeClientEventConversationItemCreate, RealtimeClientEventConversationItemDelete, RealtimeClientEventConversationItemRetrieve, RealtimeClientEventConversationItemTruncate, RealtimeClientEventInputAudioBufferAppend, RealtimeClientEventInputAudioBufferClear, RealtimeClientEventInputAudioBufferCommit, RealtimeClientEventOutputAudioBufferClear, RealtimeClientEventResponseCancel, RealtimeClientEventResponseCreate, RealtimeClientEventSessionUpdate, RealtimeClientEventTranscriptionSessionUpdate]]:
