...
class ChatCompletionRequestToolMessageContent(BaseModel):
    ...
    one_of_schemas: Set[str] = { "List[ChatCompletionRequestToolMessageContentPart]", "str" }
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], List[ChatCompletionRequestToolMessageContentPart], str]]:
