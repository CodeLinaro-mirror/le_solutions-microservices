...
class CreateThreadAndRunRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "model": CreateThreadAndRunRequestModel.from_dict(obj["model"]) if obj.get("model") is not None else None,
            "instructions": obj.get("instructions"),
            "tools": [AssistantObjectToolsInner.from_dict(_item) for _item in obj["tools"]] if obj.get("tools") is not None else None,
            "tool_resources": CreateThreadAndRunRequestToolResources.from_dict(obj["tool_resources"]) if obj.get("tool_resources") is not None else None,
