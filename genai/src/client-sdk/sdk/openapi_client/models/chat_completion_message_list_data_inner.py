...
class ChatCompletionMessageListDataInner(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "annotations": [ChatCompletionResponseMessageAnnotationsInner.from_dict(_item) for _item in obj["annotations"]] if obj.get("annotations") is not None else None,
            "role": obj.get("role"),
            ...
            "audio": ChatCompletionResponseMessageAudio.from_dict(obj["audio"]) if obj.get("audio") is not None else None,
            "id": obj.get("id")
        })
        return _obj
