...
class CreateResponse(BaseModel):
    ...
    instructions: Optional[StrictStr] = Field(default=None, description="Inserts a system (or developer) message as the first item in the model's context.  When using along with `previous_response_id`, the instructions from a previous response will not be carried over to the next response. This makes it simple to swap out system (or developer) messages in new responses. ")
    ...
    stream: Optional[StrictBool] = Field(default=False, description="If set to true, the model response data will be streamed to the client as it is generated using server-sent events. See the [Streaming section below](/docs/api-reference/responses-streaming) for more information. ")
    __properties: ClassVar[List[str]] = ["metadata", "temperature", "top_p", "user", "service_tier", "previous_response_id", "model", "reasoning", "max_output_tokens", "instructions", "text", "tools", "tool_choice", "truncation", "input", "include", "parallel_tool_calls", "store", "stream"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "model": ModelIdsResponses.from_dict(obj["model"]) if obj.get("model") is not None else None,
            ...
            "text": ResponsePropertiesText.from_dict(obj["text"]) if obj.get("text") is not None else None,
            "tools": [Tool.from_dict(_item) for _item in obj["tools"]] if obj.get("tools") is not None else None,
            "tool_choice": ResponsePropertiesToolChoice.from_dict(obj["tool_choice"]) if obj.get("tool_choice") is not None else None,
            "truncation": obj.get("truncation") if obj.get("truncation") is not None else 'disabled',
            "input": CreateResponseAllOfInput.from_dict(obj["input"]) if obj.get("input") is not None else None,
