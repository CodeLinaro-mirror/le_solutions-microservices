...
class UsageTimeBucketResultInner(BaseModel):
    ...
    one_of_schemas: Set[str] = { "CostsResult", "UsageAudioSpeechesResult", "UsageAudioTranscriptionsResult", "UsageCodeInterpreterSessionsResult", "UsageCompletionsResult", "UsageEmbeddingsResult", "UsageImagesResult", "UsageModerationsResult", "UsageVectorStoresResult" }
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], CostsResult, UsageAudioSpeechesResult, UsageAudioTranscriptionsResult, UsageCodeInterpreterSessionsResult, UsageCompletionsResult, UsageEmbeddingsResult, UsageImagesResult, UsageModerationsResult, UsageVectorStoresResult]]:
