...
class TextResponseFormatConfiguration(BaseModel):
    ...
    one_of_schemas: Set[str] = { "ResponseFormatJsonObject", "ResponseFormatText", "TextResponseFormatJsonSchema" }
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], ResponseFormatJsonObject, ResponseFormatText, TextResponseFormatJsonSchema]]:
