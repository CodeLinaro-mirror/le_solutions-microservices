...
class ChatCompletionRequestAssistantMessage(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "content": ChatCompletionRequestAssistantMessageContent.from_dict(obj["content"]) if obj.get("content") is not None else None,
            "refusal": obj.get("refusal"),
            "role": obj.get("role"),
            "name": obj.get("name"),
            "audio": ChatCompletionRequestAssistantMessageAudio.from_dict(obj["audio"]) if obj.get("audio") is not None else None,
