...
class RunStepDetailsToolCallsObjectToolCallsInner(BaseModel):
    ...
    one_of_schemas: Set[str] = { "RunStepDetailsToolCallsCodeObject", "RunStepDetailsToolCallsFileSearchObject", "RunStepDetailsToolCallsFunctionObject" }
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], RunStepDetailsToolCallsCodeObject, RunStepDetailsToolCallsFileSearchObject, RunStepDetailsToolCallsFunctionObject]]:
