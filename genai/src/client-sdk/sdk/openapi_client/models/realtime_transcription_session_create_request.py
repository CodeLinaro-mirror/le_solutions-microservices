...
class RealtimeTranscriptionSessionCreateRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "input_audio_transcription": RealtimeTranscriptionSessionCreateRequestInputAudioTranscription.from_dict(obj["input_audio_transcription"]) if obj.get("input_audio_transcription") is not None else None,
            "turn_detection": RealtimeTranscriptionSessionCreateRequestTurnDetection.from_dict(obj["turn_detection"]) if obj.get("turn_detection") is not None else None,
