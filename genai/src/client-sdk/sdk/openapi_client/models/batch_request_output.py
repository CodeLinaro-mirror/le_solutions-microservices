...
class BatchRequestOutput(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "response": BatchRequestOutputResponse.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "error": BatchRequestOutputError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
