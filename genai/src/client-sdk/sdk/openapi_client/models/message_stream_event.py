...
class MessageStreamEvent(BaseModel):
    ...
    one_of_schemas: Set[str] = { "MessageStreamEventOneOf", "MessageStreamEventOneOf1", "MessageStreamEventOneOf2", "MessageStreamEventOneOf3", "MessageStreamEventOneOf4" }
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], MessageStreamEventOneOf, MessageStreamEventOneOf1, MessageStreamEventOneOf2, MessageStreamEventOneOf3, MessageStreamEventOneOf4]]:
