...
class FineTuneMethod(BaseModel):
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['supervised', 'dpo']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "supervised": FineTuneSupervisedMethod.from_dict(obj["supervised"]) if obj.get("supervised") is not None else None,
            "dpo": FineTuneDPOMethod.from_dict(obj["dpo"]) if obj.get("dpo") is not None else None
        })
        return _obj
