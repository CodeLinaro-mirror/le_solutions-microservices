...
class CreateTranscriptionResponseStreamEvent(BaseModel):
    ...
    any_of_schemas: Set[str] = { "TranscriptTextDeltaEvent", "TranscriptTextDoneEvent" }
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], TranscriptTextDeltaEvent, TranscriptTextDoneEvent]]:
