...
create_model_response_properties_instance = CreateModelResponseProperties.from_json(json)
# print the JSON string representation of the object
print(CreateModelResponseProperties.to_json())

# convert the object into a dict
create_model_response_properties_dict = create_model_response_properties_instance.to_dict()
# create an instance of CreateModelResponseProperties from a dict
create_model_response_properties_from_dict = CreateModelResponseProperties.from_dict(create_model_response_properties_dict)
```
