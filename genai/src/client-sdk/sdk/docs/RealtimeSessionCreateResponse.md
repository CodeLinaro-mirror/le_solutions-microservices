...
**input_audio_transcription** | [**RealtimeSessionCreateResponseInputAudioTranscription**](RealtimeSessionCreateResponseInputAudioTranscription.md) |  | [optional] 
...
realtime_session_create_response_instance = RealtimeSessionCreateResponse.from_json(json)
# print the JSON string representation of the object
print(RealtimeSessionCreateResponse.to_json())

# convert the object into a dict
realtime_session_create_response_dict = realtime_session_create_response_instance.to_dict()
# create an instance of RealtimeSessionCreateResponse from a dict
realtime_session_create_response_from_dict = RealtimeSessionCreateResponse.from_dict(realtime_session_create_response_dict)
```
