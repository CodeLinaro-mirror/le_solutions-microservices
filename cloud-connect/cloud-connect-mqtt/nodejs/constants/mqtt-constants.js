 ...
 * Description :- The file stores the constants related to MQTT based interaction.
 */
'use strict';
...
export const MQTTConstants = Object.freeze({
  ...
  CONNECTION_KEEPALIVE: 60, // Keep alive Interval in seconds at which PINGREQ is sent in case of idle connection.
  CONNECTION_PROTCOL_VERSION: 5, // Can be set to 3 (v3.1), 4 (v3.1.1) and 5 (v5.0)
  CONNECTION_TIMEOUT: 120000, // 120 seconds timeout declared in milliseconds
  CONNECTION_RECONNECT_PERIOD: 10000, // 10 seconds interval before retrying connection.
