...
jest.mock('../../constants/mqtt-constants.js');

jest.mock('../../cloud-connect.js', () => {
    const originalModule = jest.requireActual('../../cloud-connect.js');
    return {
        ...originalModule,
        CloudConnect: {
...
beforeAll(() => {
    ...
    mqttBroker = new AedesBroker(mqttBrokerPort, true,
        '__mocks__/server_certificates/rootca.pem.crt',
        '__mocks__/server_certificates/server.pem.crt',
        '__mocks__/server_certificates/server.private.pem.key');
...
describe('MQTT Publisher', () => {
    ...
    beforeAll(() => {
        ...
        sslConfig[MQTTConstants.CONNECTION_ROOT_CA_FILE_KEY] = '__test__/certificates/rootca.pem.crt';
        sslConfig[MQTTConstants.CONNECTION_CLIENT_CERT_FILE_KEY] = '__test__/certificates/certificate.pem.crt';
        sslConfig[MQTTConstants.CONNECTION_CLIENT_KEY_FILE_KEY] = '__test__/certificates/private.pem.key';
    ...
    it('Validate successful message publication by the MQTT Publisher to a subscribed topic with encrypted client key', async () => {
        ...
        var pwdSSLConfig = {};
        pwdSSLConfig[MQTTConstants.CONNECTION_ROOT_CA_FILE_KEY] = '__test__/certificates_with_password/rootca.pem.crt';
        pwdSSLConfig[MQTTConstants.CONNECTION_CLIENT_CERT_FILE_KEY] = '__test__/certificates_with_password/certificate.pem.crt';
        pwdSSLConfig[MQTTConstants.CONNECTION_CLIENT_KEY_FILE_KEY] = '__test__/certificates_with_password/private.pem.key';
