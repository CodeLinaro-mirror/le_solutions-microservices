...
FILE NAME
    cloud_connect_mqtt_logging.h

DESCRIPTION
    Header file for the logging function of Cloud Connect MQTT service.
*/

#ifndef CLOUD_CONNECT_MQTT_LOGGING_H_
#define CLOUD_CONNECT_MQTT_LOGGING_H_
