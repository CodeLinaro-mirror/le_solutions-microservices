...
describe('Kafka Publisher', () => {
    ...
    beforeAll(async () => {
        ...
        sslConfig[KafkaConstants.CONNECTION_ROOT_CA_FILE_KEY] = '__test__/certificates/rootca.pem.crt';
        sslConfig[KafkaConstants.CONNECTION_CLIENT_CERT_FILE_KEY] = '__test__/certificates/certificate.pem.crt';
        sslConfig[KafkaConstants.CONNECTION_CLIENT_KEY_FILE_KEY] = '__test__/certificates/private.pem.key';
